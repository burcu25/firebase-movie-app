...
///spanın classnamindeki içiçe ternary i bu şekilde fonksiyon ile de oluşturabiliriz.
// const setVoteClass = (vote) => {
  ...
  return (
    <div className='movie' onClick={()=> currentUser ? navigate("details/"+id) : alert("Please login to see details!")}>
